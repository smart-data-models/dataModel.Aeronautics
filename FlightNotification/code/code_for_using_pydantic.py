...
class FlightNotification(BaseModel):
    ...
    ] = Field(None, description='Reference to the flight entity')
    ...
    dateIssued: Optional[AwareDatetime] = Field(
        None, description='Date when the notification was created'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be FlightNotification'
    )
